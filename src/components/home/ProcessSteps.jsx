...
const steps = [
  ...
  },
  {
    ...
    badge: '1-2 дня',
    badgeType: 'green',
    title: 'Оплата, оформление и осмотр автомобиля',
    desc: 'После выбора автомобиля производится оплата. Наша комиссия составляет всего $200. Выезд на осмотр автомобиля и подробную проверку.',
    items: [
      'Подписание договора',
      'Оплата комиссии 200$',
  ...
  },
  {
    ...
    badgeType: 'orange',
    title: 'Возврат НДС 6.3%',
    desc: 'При экспорте автомобиля из Кореи вы получаете возврат 6.3% НДС от стоимости автомобиля.',
    items: [
      'Оформление возврата НДС',
      'Получение 6.3% от стоимости авто',
      'Экономия на покупке',
    ],
  },
  {
